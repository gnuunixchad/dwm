...
static const Key keys[] = {
	...
	{ MODKEY|ShiftMask,             XK_underscore, spawn,      SHCMD("${HOME}/.local/bin/audio sink --minus") },
	{ MODKEY,                       XK_equal,      spawn,      SHCMD("${HOME}/.local/bin/audio sink --plus10") },
	{ MODKEY|ShiftMask,             XK_plus,       spawn,      SHCMD("${HOME}/.local/bin/audio sink --plus") },
	...
	{ MODKEY|ControlMask|ShiftMask, XK_underscore, spawn,      SHCMD("${HOME}/.local/bin/audio source --minus") },
	{ MODKEY|ControlMask,           XK_equal,      spawn,      SHCMD("${HOME}/.local/bin/audio source --plus10") },
	{ MODKEY|ControlMask|ShiftMask, XK_plus,       spawn,      SHCMD("${HOME}/.local/bin/audio source --plus") },
	...
	{ MODKEY|ShiftMask,             XK_braceleft,  spawn,      SHCMD("${HOME}/.local/bin/bright --minus") },
	{ MODKEY,                       XK_bracketright,spawn,     SHCMD("${HOME}/.local/bin/bright --plus10") },
	{ MODKEY|ShiftMask,             XK_braceright, spawn,      SHCMD("${HOME}/.local/bin/bright --plus") },
	{ MODKEY|ControlMask|ShiftMask, XK_braceleft,  spawn,      SHCMD("${HOME}/.local/bin/bright --min") },
	{ MODKEY|ControlMask|ShiftMask, XK_braceright, spawn,      SHCMD("${HOME}/.local/bin/bright --max") },
	{ MODKEY|ShiftMask,             XK_w,      spawn,          SHCMD("i3lock") },
